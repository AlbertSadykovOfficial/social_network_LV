<?php 
		...
		if ($view == $user) 
		{
 		...
 		// showProfile($view); // Вывести профиль пользователя
 		...
 		if (!$friends) echo "<br> Пока у вас нет друзей.<br><br>";

 		echo "<a class='button' href='messages.php?view=$view'>"."$name2 Сообщения </a>";
 ?>
